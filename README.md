...
- [jainaman224/Algo_Ds_Notes](https://github.com/jainaman224/Algo_Ds_Notes) - A comprehensive resource for learning and implementing algorithms and data structures. This repository includes detailed notes, complexity analysis, and code examples in C++, Java, Python, and more. I
...
- [kind2-mc/kind2](https://github.com/kind2-mc/kind2) - Multi-engine SMT-based automatic model checker for safety properties of Lustre programs
...
- [furuycom/ProtectorHosts](https://github.com/furuycom/ProtectorHosts) - Protect your IP address by blocking IP grabber and IP logger domains.
...
- [THUDM/Self-Contrast](https://github.com/THUDM/Self-Contrast) - Extensive Self-Contrast Enables Feedback-Free Language Model Alignment
...
- [OSU-NLP-Group/HippoRAG](https://github.com/OSU-NLP-Group/HippoRAG) - HippoRAG is a novel RAG framework inspired by human long-term memory that enables LLMs to continuously integrate knowledge across external documents. RAG + Knowledge Graphs + Personalized PageRank.
...
- [kennethnym/mai](https://github.com/kennethnym/mai) - Multilayer Authenticity Identifier (MAI), a CNN model that attempts to identify synthetic AI images.
...
- [OpenRLHF/OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) - An Easy-to-use, Scalable and High-performance RLHF Framework (70B+ PPO Full Tuning & Iterative DPO & LoRA & Mixtral)
...
- [elastic/ecs-logging-python](https://github.com/elastic/ecs-logging-python) - 
...
- [dromzeh/dromzeh.dev](https://github.com/dromzeh/dromzeh.dev) - Source code for my personal site & blog, made with NextJS (app), Million, Tailwind - deployed on Cloudflare Pages
