...
- [Vanderscycle/dot-config](https://github.com/Vanderscycle/dot-config) - my configuration
...
- [rogeriochaves/litechain](https://github.com/rogeriochaves/litechain) - Build robust LLM applications with true composability 🔗
