...
- [kske-igrshi/manjaro-to-arch.sh](https://github.com/kske-igrshi/manjaro-to-arch.sh) - A script for converting a Manjaro installation to an Arch installation with a single command
